...
CREATE TABLE "public"."compareareacode"( 
	"mrn" int,
	"areaode" varchar(50),
	"patientname" varchar(82));

CREATE TABLE "public"."comparedataafter"( 
	"mrn" int,
	"areacode" varchar(50),
	"popupentry" int,
	"recordstated" int);
...
CREATE TABLE "woundmanagement"."casedatatemp"( 
	"casedatauniqueid" bigint NOT NULL,
	"customerid" bigint NOT NULL,
	"tenantid" bigint NOT NULL,
	"recordstate" smallint NOT NULL,
...
CREATE TABLE "woundmanagement"."laboratoryacquisitiontemp"( 
	"pkid" bigint NOT NULL,
...
CREATE TABLE "woundmanagement"."laboratoyorderservicetemp"( 
	"pkid" bigint NOT NULL,
	"laboratoryorderserviceid" uuid NOT NULL,
	"customerid" bigint NOT NULL,
	"tenantid" bigint NOT NULL,
...
CREATE TABLE "woundmanagement"."medicalcasedatatemp"( 
	"pkid" bigint NOT NULL,
	"customerid" bigint NOT NULL,
	"tenantid" bigint NOT NULL,
	"recordstate" smallint NOT NULL,
...
CREATE TABLE "woundmanagement"."ordertemp"( 
	"pkid" bigint NOT NULL,
	"customerid" bigint NOT NULL,
	"tenantid" bigint NOT NULL,
	"recordstate" smallint NOT NULL,
...
CREATE TABLE "woundmanagement"."patienttemp"( 
	"pkid" bigint NOT NULL,
	"patientid" uuid NOT NULL,
	"customerid" bigint NOT NULL,
	"tenantid" bigint NOT NULL,
...
CREATE TABLE "woundmanagement"."physicalcasedatatemp"( 
	"physicalcaseid" bigint NOT NULL,
	"customerid" bigint NOT NULL,
	"tenantid" bigint NOT NULL,
	"recordstate" smallint NOT NULL,
