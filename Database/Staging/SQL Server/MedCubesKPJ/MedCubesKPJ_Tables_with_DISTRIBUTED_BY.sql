...
CREATE TABLE "physicalcasedata"( 
	...
	"bedtype" int,
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (physicalcaseid);
...
CREATE TABLE "plannedcasedataextension"( 
	...
	"comment" varchar,
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (plannedcasedataextensionid);
...
CREATE TABLE "documentinfo"( 
	...
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (documentid);
...
CREATE TABLE "vitalparameterdynamicappdataorigin"( 
	...
	"dynamicfielduniqueid" varchar NOT NULL,
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (pkid);
