...
CREATE TABLE "assignedconsultant"( 
	...
	"dmig_tag" int) DISTRIBUTED BY (pkid);
...
CREATE TABLE "casedata"( 
	...
	"comment" varchar,
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (casedatauniqueid);
...
CREATE TABLE "diagnosis"( 
	...
	"ageuntildays" int,
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (customerid);
...
CREATE TABLE "service"( 
	...
	"isexternal" boolean,
	"planningtaskid" uuid) DISTRIBUTED BY (pkid);
...
CREATE TABLE "serviceunit"( 
	...
	"validfrom" date,
	"validuntil" date,
	"taskid" uuid) DISTRIBUTED BY (serviceunitid);
...
CREATE TABLE "patientcalendarentryresourcerelationship"( 
	...
	"rowversion" bytea NOT NULL,
	"patientcalendarentryid" uuid NOT NULL,
	"resourceid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "resourceresourcegrouprelationship"( 
	...
	"rowversion" bytea NOT NULL,
	"resourceid" uuid NOT NULL,
	"resourcegroupid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "documentinfo"( 
	...
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (content);
...
CREATE TABLE "appassembly"( 
	...
	"apppartnerid" uuid NOT NULL) DISTRIBUTED BY (appassemblyid);
...
CREATE TABLE "desktoponprofile"( 
	...
	"profileid" uuid NOT NULL) DISTRIBUTED BY (desktoponprofileid);
...
CREATE TABLE "history"( 
	...
	"transactionid" uuid NOT NULL) DISTRIBUTED BY (historyid);
...
CREATE TABLE "manualactiontilestate"( 
	...
	"recordstate" smallint NOT NULL,
	"rowversion" bytea NOT NULL,
	"actiontileid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "mediastorage"( 
	...
	"dmig_refid" varchar(100),
	"dmig_tag" int) DISTRIBUTED BY (rowversion);
...
CREATE TABLE "profile"( 
	...
	"pkid" bigint NOT NULL,
	"validfrom" date NOT NULL,
	"validto" date) DISTRIBUTED BY (name);
...
CREATE TABLE "profileofuser"( 
	...
	"tenantid" bigint NOT NULL,
	"isdefault" boolean NOT NULL,
	"profileid" uuid NOT NULL) DISTRIBUTED BY (profileofuserid);
...
CREATE TABLE "refreshstate"( 
	...
	"changedbyapp" uuid) DISTRIBUTED BY (pkid);
...
CREATE TABLE "scopepermissiongridrelationship"( 
	...
	"tenantid" bigint NOT NULL,
	"profileid" uuid NOT NULL,
	"groupkey" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "searchstructure"( 
	...
	"pkid" bigint NOT NULL,
	"owner" bigint,
	"fontsettings" varchar(500)) DISTRIBUTED BY (rowversion);
...
CREATE TABLE "textphrase"( 
	...
	"pkid" bigint NOT NULL,
	"owner" bigint) DISTRIBUTED BY (rowversion);
...
CREATE TABLE "translationsource"( 
	...
	"appassemblyid" uuid) DISTRIBUTED BY (pkid);
...
CREATE TABLE "uiapp"( 
	...
	"rowversion" bytea NOT NULL,
	"mediastorageid" uuid) DISTRIBUTED BY (uiappid);
...
CREATE TABLE "wfcustomizedactivitytask"( 
	...
	"rowversion" bytea NOT NULL,
	"activityid" uuid NOT NULL,
	"taskid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "hl7mapper"( 
	...
	"popupheaderid" uuid) DISTRIBUTED BY (pkid);
...
CREATE TABLE "anamnesisdiagnosis"( 
	...
	"dynamicfieldid" uuid NOT NULL,
	"nursingdiagnosisdataid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "anamnesispathway"( 
	...
	"anamnesispkid" bigint NOT NULL,
	"dynamicfieldid" uuid NOT NULL,
	"pathwayid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "nursingdiagnosisdatareferencerelationship"( 
	...
	"nursingdiagnosisdataid" uuid NOT NULL,
	"nursingreferenceid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "pathwaybasedata"( 
	...
	"pathwaydiagnosisid" uuid NOT NULL) DISTRIBUTED BY (pkid);
...
CREATE TABLE "pathwaymaterial"( 
	...
	"pathwayserviceid" uuid NOT NULL) DISTRIBUTED BY (pkid);
