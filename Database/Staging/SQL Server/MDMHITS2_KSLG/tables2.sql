...
CREATE TABLE "public"."apactdetails"( 
...
CREATE TABLE "public"."apactheaders"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36),
	"source" varchar(4),
	"trantype" varchar(4),
...
CREATE TABLE "public"."apallocations"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36),
	"source" varchar(4),
	"trantype" varchar(4),
...
CREATE TABLE "public"."activereportparams"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."activereporttasks"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."admissionsources"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."alerttypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."allocationdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."allocationheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."antibioticsetups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."antibiotictypes"( 
	"id" int NOT NULL,
...
CREATE TABLE "public"."appfunctions"( 
	"id" varchar(36) NOT NULL,
	...
	"updateuserid" varchar(36) NOT NULL,
	"updatedate" timestamp NOT NULL,
	"menuversion" varchar(10));

CREATE TABLE "public"."appoperations"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."areagroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."assetperiods"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."assetsummary"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."assettransactions"( 
	"id" varchar(36) NOT NULL,
	"assetid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."assets"( 
	...
	"description" varchar(200),
	"assetbatchno" varchar(30));

CREATE TABLE "public"."authoriserdepartments"( 
	"authoriserid" varchar(36) NOT NULL,
	"departmentid" varchar(36) NOT NULL);

CREATE TABLE "public"."authorisertranstypes"( 
	"authoriserid" varchar(36) NOT NULL,
	"transtypeid" varchar(36) NOT NULL);

CREATE TABLE "public"."authorisers"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."babyapgarscoretypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."babyapgarscores"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."baddebtoralls"( 
	"id" varchar(36) NOT NULL,
	...
	"doctranstype" varchar(36));

CREATE TABLE "public"."baddebtors"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36),
	"companyid" varchar(36) NOT NULL,
	"line" int,
...
CREATE TABLE "public"."banksummaries"( 
	"id" varchar(36) NOT NULL,
	"fiscalyearid" varchar(36) NOT NULL,
	"periodid" varchar(36) NOT NULL,
	"bankid" varchar(36),
...
CREATE TABLE "public"."banksuppliers"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."banks"( 
	...
	"swiftcode" varchar(10),
	"achcode" varchar(10),
	"banktypeid" varchar(36));

CREATE TABLE "public"."barcodeprinters"( 
	"id" varchar(36) NOT NULL,
	"line" int,
...
CREATE TABLE "public"."bbraunconsignmentstemps"( 
	"productid" varchar(36) NOT NULL,
	"itemcode" varchar(30),
	"description" varchar(80),
...
CREATE TABLE "public"."bedallocations"( 
	"id" varchar(36) NOT NULL,
	...
	"updateuserid" varchar(36) NOT NULL,
	"updatedate" timestamp NOT NULL,
	"isolatedreasonid" varchar(36));

CREATE TABLE "public"."bedbookings"( 
	"id" varchar(36) NOT NULL,
	"bedid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."bedstatusbedstatustypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."bedstatusgroup"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."bedstatuslogs"( 
	"id" varchar(36) NOT NULL,
	"bedid" varchar(36),
	"bedstatusid" varchar(36),
	"patientid" varchar(36),
...
CREATE TABLE "public"."bedstatustypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."bedsubstatus"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(10) NOT NULL,
...
CREATE TABLE "public"."bedtransactions"( 
	"id" varchar(36) NOT NULL,
	"bedid" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."bedtypewaitlists"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."billtrackings"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."billtypemasters"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."cbtransactiondetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."cbtransactions"( 
	"id" varchar(36) NOT NULL,
	"bankid" varchar(36),
	"appoperationid" varchar(36),
	"source" varchar(4),
...
CREATE TABLE "public"."canceloperations"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."cardcenters"( 
	"id" varchar(36) NOT NULL,
	"cardcode" varchar(16),
...
CREATE TABLE "public"."cardtypefamilycodes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."casegroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."categories_tmpdu"( 
	"id" varchar(36),
	"catcode" varchar(50),
	"description" varchar(100),
...
CREATE TABLE "public"."chargebilltypemarkups"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chargeclasses"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chargediscounts"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"billtypeid" varchar(36),
	"chargegroupid" varchar(36),
...
CREATE TABLE "public"."chargegroupdepartments"( 
	"id" varchar(36) NOT NULL,
	"chargegroupid" varchar(36) NOT NULL,
	"departmentid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chargemasterbilltypeaccounts"( 
	"id" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chargemasters"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chargetaxes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chargetransactions"( 
	"id" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"episodeid" varchar(36),
	"docref" varchar(30),
	...
	"transdatetruncatedtominutes" varchar);

CREATE TABLE "public"."chargetransactionsextents"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."chequeregisters"( 
	"id" varchar(36) NOT NULL,
	"bankid" varchar(36),
...
CREATE TABLE "public"."chequetransactions"( 
	"id" varchar(36) NOT NULL,
	"bankid" varchar(36),
	"chequeno" varchar(10),
	"amount" numeric(21, 8),
...
CREATE TABLE "public"."companyinfos"( 
	"id" int NOT NULL,
	"companyid" varchar(36),
	"phoneno" varchar(50),
	"faxno" varchar(50),
...
CREATE TABLE "public"."companylists"( 
...
CREATE TABLE "public"."consignmentsku"( 
	"deptcode" varchar(50),
	"skuno" varchar(50),
	"itemcode" varchar(50) NOT NULL,
	"itemdesc" varchar(100));

CREATE TABLE "public"."contactbank"( 
	"bankid" varchar(36) NOT NULL,
	"contacts_id" varchar(100) NOT NULL);

CREATE TABLE "public"."contactdepartment"( 
	"departments_id" varchar(36) NOT NULL,
	"contacts_id" varchar(100) NOT NULL);

CREATE TABLE "public"."contactemployee"( 
...
CREATE TABLE "public"."crcontrolgrps"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtoractheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtorgroupexceptions"( 
	"id" varchar(36) NOT NULL,
	"chargegroupid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtorgroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtoritemexceptions"( 
	"id" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
	"debtormasterid" varchar(50) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtormasteronlines"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtormasters"( 
	"id" varchar(50) NOT NULL,
...
CREATE TABLE "public"."debtortypepaymodes"( 
	"id" varchar(36) NOT NULL,
	"debtortypeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."debtortypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."deliveryorderdetailstemp30march"( 
	"id" varchar(36) NOT NULL,
	"doheaderid" varchar(36) NOT NULL,
	"line" int NOT NULL,
	"productid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."deliveryorderheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."deliveryorderheaderstemp30march"( 
	"id" varchar(36) NOT NULL,
	"grnnumber" varchar(10) NOT NULL,
...
CREATE TABLE "public"."departmentlocations"( 
	"id" varchar(36) NOT NULL,
	"departmentid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."deposittransactiontypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."deposittypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."diagnosisgroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."diagnosis_diagnosisgroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."dietfooditems"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."dischargedestinations"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."dispositionendcasedtls"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."dispositionendcasehdrs"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."doctorallocations"( 
	"id" varchar(36) NOT NULL,
	...
	"allocdateonly" varchar);

CREATE TABLE "public"."doctorceiling"( 
	"id" varchar(36) NOT NULL,
	"doctorid" varchar(36) NOT NULL,
	"effectivedate" timestamp NOT NULL,
...
CREATE TABLE "public"."doctorcontributions"( 
	"id" varchar(36) NOT NULL,
	"doctorid" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
	"episodetypeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."doctorconvs"( 
	"id" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"episodeid" varchar(36),
	"debtoractheaderid" varchar(36),
	...
	"convepistype" varchar(36));

CREATE TABLE "public"."doctorgroups"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36),
	"groupcode" varchar(4),
	"updatedate" timestamp NOT NULL,
...
CREATE TABLE "public"."doctorincomes"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"doctorid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."doctorpreferencesdtls"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."doctorpreferenceshdrs"( 
	"id" varchar(36) NOT NULL,
	"doctorid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."doctorstatus"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."doctortaxinvoices"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36) NOT NULL,
	"debtoractheaderid" varchar(36),
	"auditno" int,
...
CREATE TABLE "public"."doctortransactions"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36),
	"source" varchar(20),
	"transtype" varchar(16),
...
CREATE TABLE "public"."doctors"( 
	...
	"mgtfee_processdate" timestamp);

CREATE TABLE "public"."donebynames"( 
	"id" varchar(36) NOT NULL,
	"doneby" varchar(20),
	"companyid" varchar(36) NOT NULL,
	"status" varchar(3) NOT NULL,
...
CREATE TABLE "public"."druggroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."ediexportimportdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."ediexportimportheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodeadjustment"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"adjustmenttype" varchar(2) NOT NULL,
	"remarks" varchar(100) NOT NULL);

CREATE TABLE "public"."episodealerts"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodediagnosis"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"diagnosisid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedietorderdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedietorderheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedietstatuschangedetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodediets"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedischargecomments"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedispositionappointments"( 
	"id" varchar(36) NOT NULL,
	"patientid" varchar(36) NOT NULL,
	"episodedoctorid" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedispositionmedcerts"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"patientid" varchar(36) NOT NULL,
	"episodedoctorid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodedispositionreferrals"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"episodedoctorid" varchar(36) NOT NULL,
	"toname" varchar(50),
...
CREATE TABLE "public"."episodedoctors"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"doctorid" varchar(36) NOT NULL,
	"doctorstatusid" varchar(36),
...
CREATE TABLE "public"."episodeinvspanels"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodematernities"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodenutritions"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodepatientadvices"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"episodedoctorid" varchar(36) NOT NULL,
	"advise" varchar(250),
...
CREATE TABLE "public"."episodepayerguaranteeletters"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodepayers"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodeprescriptiondtls"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodeprescriptionhdrs"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."episodetriages"( 
	"id" varchar(36) NOT NULL,
	"insertdate" date,
...
CREATE TABLE "public"."episodetypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."fixedassettemps"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."foodmenuitems"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glfinancetables"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glgroupexceptions"( 
	"id" varchar(36) NOT NULL,
	"chargegroupid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glitemexceptions"( 
	"id" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."gljournaldetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."gljournalheaders"( 
	"id" varchar(36) NOT NULL,
	"auditno" int,
	"fiscalyearid" varchar(36) NOT NULL,
	"periodid" varchar(36),
	...
	"updateuserid" varchar(36) NOT NULL,
	"updatedate" timestamp NOT NULL,
	"postuserid" varchar(36));

CREATE TABLE "public"."gleteritems"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"debtormasterid" varchar(50) NOT NULL,
	"patientid" varchar(36),
...
CREATE TABLE "public"."gletterdepartments"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"episodeid" varchar(36),
...
CREATE TABLE "public"."glaccountcostcodes"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(50) NOT NULL,
	"status" varchar(3),
	"costcenterid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glaccountdetails"( 
	"id" varchar(36) NOT NULL,
	...
	"updateuserid" varchar(36) NOT NULL,
	"updatedate" timestamp NOT NULL,
	"gljournaldetailid" varchar(36));

CREATE TABLE "public"."glaccounttypes"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(10) NOT NULL,
	"companyid" varchar(36),
	"description" varchar(50) NOT NULL,
...
CREATE TABLE "public"."glaccounts_tmpdu"( 
	"id" varchar(36),
...
CREATE TABLE "public"."glconaccountdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glconaccountdetails_temp"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glcondepartmentdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glcondepartments"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glconsolidatedaccounts"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(50) NOT NULL,
	"description" varchar(100),
	"status" varchar(3) NOT NULL,
...
CREATE TABLE "public"."glconsolidatedaccounts_temp"( 
	"id" varchar(36),
	"code" varchar(50) NOT NULL,
	"description" varchar(100),
	"status" varchar(3) NOT NULL,
...
CREATE TABLE "public"."gliaccountmappings"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36),
...
CREATE TABLE "public"."glinterfaces"( 
	"id" varchar(36) NOT NULL,
	"paramsourceid" varchar(36),
	"appoperationid" varchar(36),
	"trantypeid" varchar(36),
...
CREATE TABLE "public"."glreportformats"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."glreportformats_test"( 
	"id" varchar(36),
...
CREATE TABLE "public"."glsubacctypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."gltransactions"( 
	"id" varchar(36) NOT NULL,
	"fiscalyearid" varchar(36) NOT NULL,
	"periodid" varchar(36),
	"paramsourceid" varchar(36),
	...
	"postdatemonth" varchar);

CREATE TABLE "public"."goodsreturndetails"( 
	"id" varchar(36) NOT NULL,
	"line" int NOT NULL,
...
CREATE TABLE "public"."goodsreturnheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."groupfunction"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."groupoperation"( 
	"groups_id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."guaranteeletterentitledoctors"( 
	"id" varchar(36) NOT NULL,
	"doctorid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."guaranteeletterreferences"( 
	"id" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"debtorid" varchar(50) NOT NULL,
...
CREATE TABLE "public"."guaranteelettertypes"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."interfacelogs"( 
...
CREATE TABLE "public"."invdspdetails"( 
	"id" varchar(36) NOT NULL,
	"recno" int,
	"line" int,
	"productid" varchar(36),
...
CREATE TABLE "public"."invhistorydetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."invhistoryheaders"( 
	"id" varchar(36) NOT NULL,
	"departmentid" varchar(36),
	"transtypeid" varchar(36),
	"docno" int,
...
CREATE TABLE "public"."invrequestdetails"( 
	"id" varchar(36) NOT NULL,
	"reqdepartmentid" varchar(36),
...
CREATE TABLE "public"."invrequestheader"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."invtransdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."invtransheader"( 
	"id" varchar(36) NOT NULL,
	"fromdepartmentid" varchar(36),
	"todepartmentid" varchar(36),
	"invissuetype" varchar(10),
	...
	"sndrcvtypeid" varchar(36));

CREATE TABLE "public"."isolationreasons"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."itembatches"( 
	"id" varchar(36) NOT NULL,
	"productid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."itemcountsets"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."itemcountsetsdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."itemcountsetsheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."itemmonthlystocks"( 
	"id" varchar(36) NOT NULL,
	"itemstocklocationid" varchar(36),
	"periodid" varchar(36),
...
CREATE TABLE "public"."itemperiodicaveragecosts"( 
	"id" varchar(36) NOT NULL,
	"productid" varchar(36) NOT NULL,
	"fiscalyearid" varchar(36) NOT NULL,
	"periodid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."itemstocklocations"( 
	"id" varchar(36) NOT NULL,
	"departmentid" varchar(36) NOT NULL,
	"productid" varchar(36),
	"bincode" varchar(16),
...
CREATE TABLE "public"."itemstocklocations_backup14march"( 
	"id" varchar(36) NOT NULL,
	"departmentid" varchar(36) NOT NULL,
	"productid" varchar(36),
	"bincode" varchar(16),
...
CREATE TABLE "public"."itemtaxdetails"( 
	"id" varchar(36) NOT NULL,
	"paramsourceid" varchar(36),
	"transtypeid" varchar(36),
	"sourceid" varchar(36),
...
CREATE TABLE "public"."itemtracks"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mispatientstatmonth"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mispatientstatyear"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mmaclasses"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mmamasters"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mmamasters_tdm"( 
	"id" varchar(255),
	"mmacode" varchar(255),
	"description" varchar(255),
...
CREATE TABLE "public"."mmasubgroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mmatransactions"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"patientid" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."mrrequestnotifications"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternityadmissioin"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternitybabyrecords"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternitycontrolparams"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternitylabourdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternityoxytoxicdrugs"( 
	"id" varchar(36) NOT NULL,
	"episodematernityid" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
	"dosageid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternitystageoneandtwodetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."maternitystagethreedetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."medicalrecordmovements"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."medicalrecordrequests"( 
	"id" varchar(36) NOT NULL,
	"medicalrecordid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."membershipcardtypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."membershipcards"( 
	"id" varchar(36) NOT NULL,
	"cardtypeid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."modificationlogs"( 
	"id" varchar(36) NOT NULL,
	"lineno" int NOT NULL,
	"module" varchar(250),
	"submodule" varchar(100),
...
CREATE TABLE "public"."movementstats"( 
	"id" varchar(36) NOT NULL,
	"name" varchar(50),
	"description" varchar(50),
	"status" varchar(3),
...
CREATE TABLE "public"."mrncomments"( 
	"companyid" varchar(36),
	"description" varchar(50),
	"name" varchar(50),
	"noteexist" boolean,
...
CREATE TABLE "public"."nextofkins"( 
	"id" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"seqno" int NOT NULL,
...
CREATE TABLE "public"."nutritionstatuschangedetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."otdutyroomreservations"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."otoncallteams"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."otreservations"( 
	"id" varchar(36) NOT NULL,
	"roomid" varchar(36),
	"companyid" varchar(36) NOT NULL,
	"patientid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."otteammembertypes"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(36) NOT NULL,
	"description" varchar(50),
	"sequence" smallint,
...
CREATE TABLE "public"."ordersetdetails"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(10),
	"description" varchar(150),
	"chargemasterid" varchar(36),
...
CREATE TABLE "public"."ordersetheaders"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(8) NOT NULL,
	"description" varchar(150),
	"chargemasterid" varchar(36),
...
CREATE TABLE "public"."pmtrackings"( 
	"id" varchar(36) NOT NULL,
	"departmentid" varchar(36),
	"episodeid" varchar(36),
	"locationid" varchar(36),
...
CREATE TABLE "public"."posignature"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"departmentid" varchar(36) NOT NULL,
	"effdate" timestamp,
...
CREATE TABLE "public"."packagedetailprices"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."packagedetails"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"packagemasterid" varchar(36),
	"chargemasterid" varchar(36),
...
CREATE TABLE "public"."packagemasters"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."packagerevisionprices"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."packagerevisions"( 
	"id" varchar(36) NOT NULL,
	"packagemasterid" varchar(36),
	"effectivedate" timestamp,
	"price" numeric(21, 8),
...
CREATE TABLE "public"."panelitems"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."paramgroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."paramsources"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."patientcomments"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."patientmovements"( 
	"id" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"mrnnumber" varchar(50),
	"name" varchar(50),
...
CREATE TABLE "public"."patients_bkup"( 
	"areaid" varchar(36),
	"active" boolean,
	"addresstypeid" varchar(36),
	"admitic" varchar(50),
...
CREATE TABLE "public"."paygrouppaymodes"( 
...
CREATE TABLE "public"."payergroupexceptions"( 
	"id" varchar(36) NOT NULL,
	"chargegroupid" varchar(36) NOT NULL,
	"debtormasterid" varchar(50) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."payeritemexceptions"( 
	"id" varchar(36) NOT NULL,
	"chargemasterid" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."pendingprocesses"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."physicalcountdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."pricesources"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."pricetypes"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."privilegesdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."prodsubcategories"( 
	"id" varchar(36) NOT NULL,
	"productcategoryid" varchar(36),
	"code" varchar(30),
	"description" varchar(80),
...
CREATE TABLE "public"."productgroups"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(30) NOT NULL,
	"description" varchar(50),
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."products"( 
	...
	"updatedate" timestamp NOT NULL,
	"noteexist" boolean,
	"assetscategoryid" varchar(36));

CREATE TABLE "public"."products_tmpdu"( 
	"id" varchar(36),
	"itemcode" varchar(30),
	"description" varchar(80),
...
CREATE TABLE "public"."purchaseorderheaders"( 
	"id" varchar(36) NOT NULL,
	...
	"prheaderid" varchar(36));

CREATE TABLE "public"."purchaserequestdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."purchaserequestheaders"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."queuesources"( 
	"id" varchar(36) NOT NULL,
	"code" varchar(10) NOT NULL,
	"description" varchar(40),
	"status" varchar(3) NOT NULL,
...
CREATE TABLE "public"."queuestartstats"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."repackitemdetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."repackitems"( 
	"id" varchar(36) NOT NULL,
	"departmentid" varchar(36),
	"productid" varchar(36) NOT NULL,
	"uomid" varchar(36),
...
CREATE TABLE "public"."repacktransdetails"( 
	"id" varchar(36) NOT NULL,
	"repackheaderid" varchar(36),
	"line" int,
	"productid" varchar(36),
...
CREATE TABLE "public"."repacktransheaders"( 
	"id" varchar(36) NOT NULL,
	"repackitemid" varchar(36),
	"uomid" varchar(36),
...
CREATE TABLE "public"."slocvsprod"( 
	"sl_dept" varchar(50),
...
CREATE TABLE "public"."slocvsprod1"( 
	"sl_dept" varchar(50),
	"product_id" varchar(50),
	"conversion_factor" varchar(50),
	"stockloc_qtyonhand" varchar(50),
...
CREATE TABLE "public"."slocvsprod3"( 
	"sl_dept" varchar(50),
	"product_id" varchar(50),
	"conversion_factor" varchar(50),
	"stockloc_qtyonhand" varchar(50),
	"stockloc_loose_ qtyonhand" varchar(50),
	"product_avgcost" varchar(50),
	"stockvalue" varchar(50));

CREATE TABLE "public"."slocvsprod4"( 
	"sl_dept" varchar(50),
	"product_id" varchar(50),
	"conversion_factor" varchar(50),
	"stockloc_qtyonhand" varchar(50),
...
CREATE TABLE "public"."searchoptions"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."searchproperties"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."sessioncontexts"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."stockcountbatchs"( 
...
CREATE TABLE "public"."stockcountdetails"( 
	"id" int NOT NULL,
...
CREATE TABLE "public"."stockcountheaders"( 
...
CREATE TABLE "public"."supplierbonusitems"( 
	"id" varchar(36) NOT NULL,
	...
	"updatedate" timestamp NOT NULL,
	"noteexist" boolean,
	"bonussuppitemcode" varchar(36));

CREATE TABLE "public"."supplierdetails"( 
	"id" varchar(36) NOT NULL,
	"appoperationid" varchar(36),
	"supplierid" varchar(36),
	"pvalue1" varchar(100),
...
CREATE TABLE "public"."suppliergroups"( 
	"id" varchar(36) NOT NULL,
	"groupcode" varchar(4),
	"description" varchar(80),
	"costcenterid" varchar(36),
...
CREATE TABLE "public"."suppliers"( 
	...
	"suppbranch" varchar(100));

CREATE TABLE "public"."suppliers_tmpdu"( 
	"id" varchar(36),
...
CREATE TABLE "public"."surgeryprocedures"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36),
...
CREATE TABLE "public"."swabcounts"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."systemparams"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."temp_selangor_patient"( 
	"patientid" varchar(36),
	"mrnnumber" int);

CREATE TABLE "public"."tmp_chargetransactions"( 
	"id" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"episodeid" varchar(36),
	"episodetypeid" varchar(36),
...
CREATE TABLE "public"."tmp_dietsummaries"( 
	"id" bigint NOT NULL,
...
CREATE TABLE "public"."tmp_dietsummarieswithmealshifts"( 
	"id" bigint NOT NULL,
	"usersessionid" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"episodedietid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."tmp_episodenutritions"( 
	"id" bigint NOT NULL,
	"usersessionid" varchar(36) NOT NULL,
	"episodeid" varchar(36) NOT NULL,
	"bedallocationid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."tmp_glinterfaces"( 
	"id" varchar(36) NOT NULL,
	"paramsourceid" varchar(36),
	"appoperationid" varchar(36),
	"trantype" varchar(36),
...
CREATE TABLE "public"."taxmasters"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."taxtransactions"( 
	"id" varchar(36) NOT NULL,
	"taxmasterid" varchar(36),
	"transtypeid" varchar(36),
	"paramsourceid" varchar(36),
...
CREATE TABLE "public"."tempbeds"( 
	"ward" varchar(255),
	"room" varchar(255),
	"bed no" varchar(255),
	"bed type" varchar(255),
	"charge code" varchar(255));

CREATE TABLE "public"."tempicd1"( 
	"icdcode" varchar(255),
...
CREATE TABLE "public"."tempicd2"( 
	"f1" varchar(255));

CREATE TABLE "public"."tempicd3"( 
	"f1" varchar(255));

CREATE TABLE "public"."tempsloc"( 
...
CREATE TABLE "public"."tempuploadhris"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."temp_bankinregisters"( 
	"id" varchar(36) NOT NULL,
	"paymodeid" varchar(36) NOT NULL,
	"reference" varchar(255),
...
CREATE TABLE "public"."temp_budget"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."temp_budgetload"( 
	"id" varchar(36) NOT NULL,
	"costcenter" varchar(36),
	"costcenterdesc" varchar(100),
	"glaccount" varchar(36),
...
CREATE TABLE "public"."temp_paymentsubmission"( 
	"id" varchar(36) NOT NULL,
	"payto" varchar(36),
	"source" varchar(36),
	"trantype" varchar(36),
...
CREATE TABLE "public"."temp_summaryin"( 
	"audino" int,
...
CREATE TABLE "public"."tilldetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."tillregistrations"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."titlecodes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."tmpchargeprices"( 
	"id" varchar(36) NOT NULL,
	"isselect" boolean,
	"chargemasterid" varchar(36),
	"chargecode" varchar(30),
...
CREATE TABLE "public"."tmp_userfunctions"( 
	"id" varchar(36) NOT NULL,
	"users_id" varchar(36) NOT NULL,
	"functions_id" varchar(36) NOT NULL,
	"exclude" boolean,
...
CREATE TABLE "public"."transgroups"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."transqueues"( 
	"id" varchar(36) NOT NULL,
	"companyid" varchar(36) NOT NULL,
	"patientid" varchar(36),
	"episodeid" varchar(36),
...
CREATE TABLE "public"."transtitles"( 
	"id" varchar(36) NOT NULL,
	"titleid" varchar(36) NOT NULL,
...
CREATE TABLE "public"."transtypes"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."transactionlogs"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."userdefinedtypes"( 
	"id" varchar(36) NOT NULL,
	"typecode" varchar(30) NOT NULL,
...
CREATE TABLE "public"."userfunction"( 
	"id" varchar(100) NOT NULL,
	"users_id" varchar(36) NOT NULL,
	"functions_id" varchar(36) NOT NULL,
	"exclude" boolean,
...
CREATE TABLE "public"."userprivilegedetails"( 
	"id" varchar(36) NOT NULL,
...
CREATE TABLE "public"."userprivileges"( 
	"id" varchar(36) NOT NULL,
	"privilegeid" varchar(36) NOT NULL,
	"userid" varchar(36) NOT NULL,
	"status" varchar(3),
...
CREATE TABLE "public"."load_omnicel"( 
	"mrn" int,
	"episodeno" varchar(15),
...
CREATE TABLE "public"."temp_selangor_prog_pat"( 
	"patientid" varchar(36),
	"conv_patientid" varchar(36));

CREATE TABLE "public"."tmpglinterface"( 
	"compcode" varchar(4),
	"source" varchar(20),
	"trantype" varchar(16),
...
CREATE TABLE "public"."tmpglinterface_error"( 
	"compcode" varchar(4),
	"source" varchar(20),
	"trantype" varchar(16),
	"reference" varchar(80),
