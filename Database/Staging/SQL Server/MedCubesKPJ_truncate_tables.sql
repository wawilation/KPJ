...
TRUNCATE TABLE compareareacode ;
TRUNCATE TABLE comparedataafter ;
...
TRUNCATE TABLE casedatatemp ;
TRUNCATE TABLE drug ;
TRUNCATE TABLE laboratoryacquisitiontemp ;
TRUNCATE TABLE laboratoyorderservicetemp ;
TRUNCATE TABLE medicalcasedatatemp ;
TRUNCATE TABLE ordertemp ;
TRUNCATE TABLE patienttemp ;
TRUNCATE TABLE physicalcasedatatemp ;
