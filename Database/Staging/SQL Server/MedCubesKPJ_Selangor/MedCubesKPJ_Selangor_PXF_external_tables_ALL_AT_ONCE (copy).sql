...
/***CREATE EXTERNAL TABLE "pxf_compareareacode"( 
	"mrn" int,
	"areaode" varchar(50),
	"patientname" varchar(82)) LOCATION ('pxf://MedCubesKPJ_Selangor.dbo.compareareacode?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/****CREATE EXTERNAL TABLE "pxf_comparedataafter"( 
	...
	"areacode" varchar(50),
	"popupentry" int,
	"recordstated" int) LOCATION ('pxf://MedCubesKPJ_Selangor.dbo.comparedataafter?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/***CREATE EXTERNAL TABLE "pxf_casedatatemp"( 
	...
	"dischargedestinationtype" int,
	"admissiondiagnosisid" varchar,
	"comment" varchar) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.casedatatemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/****CREATE EXTERNAL TABLE "pxf_laboratoryacquisitiontemp"( 
	...
	"resulttext" varchar,
	"valuestring" varchar,
	"sortorder" int) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.laboratoryacquisitiontemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/***CREATE EXTERNAL TABLE "pxf_laboratoyorderservicetemp"( 
	...
	"serviceid" varchar,
	"patientservicepkid" bigint,
	"externalreferenceid" varchar(200)) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.laboratoyorderservicetemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/****CREATE EXTERNAL TABLE "pxf_medicalcasedatatemp"( 
	...
	"validfrom" timestamp,
	"validuntil" timestamp,
	"medicalcaseid" varchar) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.medicalcasedatatemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/*****CREATE EXTERNAL TABLE "pxf_ordertemp"( 
	...
	"orderkey" varchar(50),
	"sampledatetime" timestamp) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.ordertemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/*****CREATE EXTERNAL TABLE "pxf_patienttemp"( 
	...
	"addresscountrycode" varchar(200),
	"areacode" int,
	"appointmentreminder" int) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.patienttemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
...
/*****CREATE EXTERNAL TABLE "pxf_physicalcasedatatemp"( 
	...
	"validfrom" timestamp,
	"validuntil" timestamp,
	"bedtype" int) LOCATION ('pxf://MedCubesKPJ_Selangor.woundmanagement.physicalcasedatatemp?PROFILE=Jdbc&SERVER=sqlserver3&QUOTE_COLUMNS=true&BATCH_SIZE=100000&FETCH_SIZE=100000&POOL_SIZE=8')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_import');
